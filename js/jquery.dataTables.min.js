...
function ta(a,b){a._bInitComplete=!0;(b||a.oInit.aaData)&&U(a);v(a,null,"plugin-init",[a,b]);v(a,"aoInitComplete","init",[a,b])}function Ra(a,b){var c=parseInt(b,10);a._iDisplayLength=c;Sa(a);v(a,null,"length",[a,c])}function ob(a){for(var b=a.oClasses,c=a.sTableId,d=a.aLengthMenu,e=h.isArray(d[0]),f=e?d[0]:d,d=e?d[1]:d,e=h("<select/>",{name:c+"_length","aria-controls":c,"class":b.sLengthSelect}),g=0,j=f.length;g<j;g++)e[0][g]=new Option(d[g],f[g]);var i=h("<div lol><label/></div>").addClass(b.sLength);
...
oPaginate:{sFirst:"Début",sLast:"Fin",sNext:"Suivant",sPrevious:"Précédent"},sEmptyTable:"Aucun enregistrement trouvé",sInfo:"Montrer _START_ jeux jusqu'a _END_ sur _TOTAL_ jeux",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Montrer _MENU_ jeux",sLoadingRecords:"Chargement...",sProcessing:"En cours...",sSearch:"Recherche:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Pas de jeu trouvé"},oSearch:h.extend({},
