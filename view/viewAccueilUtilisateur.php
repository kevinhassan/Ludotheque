...
if(isset($_SESSION['login'])){
    ...
    <div class="text-center" style="    margin-top: 15%;">
      ...
      <div class="style row-img">
        <div class="col-lg-4">
            <a title="Gérez vos entrainements à travers cette page" href="?action=liste" role="button"><img class="img-circle" src="./image/jeux.png" alt="Generic placeholder image" style="width: 140px; height: 140px;"></a>
          <h2>Jeux</h2>
          <p><a title="Gérez vos entrainements à travers cette page" href="?action=liste" role="button">Voir »</a></p>
        </div>
        <div class="col-lg-4">
            <a title="Gérez vos matchs à travers cette page" href="/match" role="button"><img class="img-circle" src="./image/informations.png" alt="Generic placeholder image" style="width: 140px; height: 140px;"></a>
